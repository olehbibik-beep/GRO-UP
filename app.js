...
function loadPersonalData() {
    ...
    // ИСПРАВЛЕНИЕ: ДЕЖУРСТВА - ОПОВЕЩЕНИЕ ВСЮ НЕДЕЛЮ
    try {
        ...
        onSnapshot(dutiesQuery, (snapshot) => {
            ...
            snapshot.forEach(docSnap => {
                ...
                // Ищем дежурство ИМЕННО на текущую неделю
            ...
            if (!currentDuty) {
                ...
                // 🔥 Выделяем всю неделю, если дежурит наша группа
                let alertHtml = '';
                if (isMyGroup) {
